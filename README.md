...
#### perl path_to_HIVID2_programs/all_in_one.pl  -o  output_folder  -tl  total.sample.list  -fa1  path_to_human.fa  -fa2  path_to_virus.fa  -bin  path_to_HIVID2_programs  -c  path_to_soap_config_file
