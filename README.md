# 1. Install
This is newest version of HIVID2. Just download all the files into one folder and run HIVID2 using "perl /absolute_path/all_in_one.pl parameter1 parameter2 parameter3 ......".
